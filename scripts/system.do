...
add wave -noupdate -group Fetch/Decode -expand -group ftif /system_tb/DUT/CPU/DP/FT/ftif/ihit
add wave -noupdate -group Fetch/Decode -expand -group ftif /system_tb/DUT/CPU/DP/FT/ftif/dhit
add wave -noupdate -group Fetch/Decode -expand -group ftif /system_tb/DUT/CPU/DP/FT/ftif/flush
add wave -noupdate -group Fetch/Decode -expand -group ftif /system_tb/DUT/CPU/DP/FT/ftif/freeze
add wave -noupdate -group Fetch/Decode -expand -group ftif /system_tb/DUT/CPU/DP/FT/ftif/imemload
add wave -noupdate -group Fetch/Decode -expand -group ftif /system_tb/DUT/CPU/DP/FT/ftif/fetch_p
add wave -noupdate -group Fetch/Decode -expand -group ftif /system_tb/DUT/CPU/DP/FT/ftif/imemREN
add wave -noupdate -group Fetch/Decode -expand -group ftif /system_tb/DUT/CPU/DP/FT/ftif/imemaddr
add wave -noupdate -group Fetch/Decode -expand -group ftif /system_tb/DUT/CPU/DP/FT/ftif/BranchTaken
add wave -noupdate -group Fetch/Decode -expand -group ftif /system_tb/DUT/CPU/DP/FT/ftif/BranchAddr
add wave -noupdate -group Fetch/Decode -expand -group ftif /system_tb/DUT/CPU/DP/FT/ftif/JumpSel
add wave -noupdate -group Fetch/Decode -expand -group ftif /system_tb/DUT/CPU/DP/FT/ftif/JumpAddr
add wave -noupdate -group Fetch/Decode -expand -group ftif /system_tb/DUT/CPU/DP/FT/ftif/port_a
...
add wave -noupdate -group Decode/Execute -group dcif /system_tb/DUT/CPU/DP/DC/dcif/ihit
add wave -noupdate -group Decode/Execute -group dcif /system_tb/DUT/CPU/DP/DC/dcif/dhit
add wave -noupdate -group Decode/Execute -group dcif /system_tb/DUT/CPU/DP/DC/dcif/flush
add wave -noupdate -group Decode/Execute -group dcif /system_tb/DUT/CPU/DP/DC/dcif/freeze
add wave -noupdate -group Decode/Execute -group dcif /system_tb/DUT/CPU/DP/DC/dcif/fetch_p
add wave -noupdate -group Decode/Execute -group dcif /system_tb/DUT/CPU/DP/DC/dcif/writeback_p
add wave -noupdate -group Decode/Execute -group dcif /system_tb/DUT/CPU/DP/DC/dcif/decode_p
add wave -noupdate -group Decode/Execute -group dcif /system_tb/DUT/CPU/DP/DC/dcif/porta
add wave -noupdate -group Decode/Execute -group dcif /system_tb/DUT/CPU/DP/DC/dcif/JumpSel
add wave -noupdate -group Decode/Execute -group dcif /system_tb/DUT/CPU/DP/DC/dcif/JumpAddr
add wave -noupdate -group Decode/Execute -group dcif /system_tb/DUT/CPU/DP/DC/dcif/BranchAddr
add wave -noupdate -group Decode/Execute -group dcif /system_tb/DUT/CPU/DP/DC/dcif/BranchTaken
...
add wave -noupdate -group Execute/Memory -group exif /system_tb/DUT/CPU/DP/EX/exif/ihit
add wave -noupdate -group Execute/Memory -group exif /system_tb/DUT/CPU/DP/EX/exif/dhit
add wave -noupdate -group Execute/Memory -group exif /system_tb/DUT/CPU/DP/EX/exif/flush
add wave -noupdate -group Execute/Memory -group exif /system_tb/DUT/CPU/DP/EX/exif/freeze
add wave -noupdate -group Execute/Memory -group exif /system_tb/DUT/CPU/DP/EX/exif/decode_p
add wave -noupdate -group Execute/Memory -group exif /system_tb/DUT/CPU/DP/EX/exif/port_a_forwarding_control
add wave -noupdate -group Execute/Memory -group exif /system_tb/DUT/CPU/DP/EX/exif/port_b_forwarding_control
add wave -noupdate -group Execute/Memory -group exif /system_tb/DUT/CPU/DP/EX/exif/FW_execute_data
add wave -noupdate -group Execute/Memory -group exif /system_tb/DUT/CPU/DP/EX/exif/FW_writeback_data
add wave -noupdate -group Execute/Memory -group exif /system_tb/DUT/CPU/DP/EX/exif/execute_p
...
add wave -noupdate -group Memory/Writeback -group mmif /system_tb/DUT/CPU/DP/MM/mmif/ihit
add wave -noupdate -group Memory/Writeback -group mmif /system_tb/DUT/CPU/DP/MM/mmif/dhit
add wave -noupdate -group Memory/Writeback -group mmif /system_tb/DUT/CPU/DP/MM/mmif/flush
add wave -noupdate -group Memory/Writeback -group mmif /system_tb/DUT/CPU/DP/MM/mmif/freeze
add wave -noupdate -group Memory/Writeback -group mmif /system_tb/DUT/CPU/DP/MM/mmif/execute_p
add wave -noupdate -group Memory/Writeback -group mmif /system_tb/DUT/CPU/DP/MM/mmif/dmemload
add wave -noupdate -group Memory/Writeback -group mmif /system_tb/DUT/CPU/DP/MM/mmif/memory_p
add wave -noupdate -group Memory/Writeback -group mmif /system_tb/DUT/CPU/DP/MM/mmif/dmemaddr
add wave -noupdate -group Memory/Writeback -group mmif /system_tb/DUT/CPU/DP/MM/mmif/dmemstore
add wave -noupdate -group Memory/Writeback -group mmif /system_tb/DUT/CPU/DP/MM/mmif/dmemREN
add wave -noupdate -group Memory/Writeback -group mmif /system_tb/DUT/CPU/DP/MM/mmif/dmemWEN
add wave -noupdate -group Memory/Writeback -group mmif /system_tb/DUT/CPU/DP/MM/mmif/BranchAddr
add wave -noupdate -group Memory/Writeback -group mmif /system_tb/DUT/CPU/DP/MM/mmif/JumpAddr
add wave -noupdate -group Memory/Writeback -group mmif /system_tb/DUT/CPU/DP/MM/mmif/port_a
add wave -noupdate -group Memory/Writeback -group mmif /system_tb/DUT/CPU/DP/MM/mmif/JumpSel
add wave -noupdate -group Memory/Writeback -group mmif /system_tb/DUT/CPU/DP/MM/mmif/BranchTaken
add wave -noupdate -group Memory/Writeback -group mmif /system_tb/DUT/CPU/DP/MM/mmif/forwarding_unit_data
...
add wave -noupdate -group Datapath -group huif /system_tb/DUT/CPU/DP/HU/huif/BranchTaken
