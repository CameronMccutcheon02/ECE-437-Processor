...
add wave -noupdate -radix unsigned /dcache_tb/DUT/nxt_dcache
...
add wave -noupdate -group CIF /dcache_tb/PROG/cif/iwait
add wave -noupdate -group CIF /dcache_tb/PROG/cif/dwait
add wave -noupdate -group CIF /dcache_tb/PROG/cif/iREN
add wave -noupdate -group CIF /dcache_tb/PROG/cif/dREN
add wave -noupdate -group CIF /dcache_tb/PROG/cif/dWEN
add wave -noupdate -group CIF /dcache_tb/PROG/cif/iload
add wave -noupdate -group CIF /dcache_tb/PROG/cif/dload
add wave -noupdate -group CIF /dcache_tb/PROG/cif/dstore
add wave -noupdate -group CIF /dcache_tb/PROG/cif/iaddr
add wave -noupdate -group CIF /dcache_tb/PROG/cif/daddr
add wave -noupdate -group CIF /dcache_tb/PROG/cif/ccwait
add wave -noupdate -group CIF /dcache_tb/PROG/cif/ccinv
add wave -noupdate -group CIF /dcache_tb/PROG/cif/ccwrite
add wave -noupdate -group CIF /dcache_tb/PROG/cif/cctrans
add wave -noupdate -group CIF /dcache_tb/PROG/cif/ccsnoopaddr
add wave -noupdate -expand -group DCIF /dcache_tb/PROG/dcif/halt
add wave -noupdate -expand -group DCIF /dcache_tb/PROG/dcif/ihit
add wave -noupdate -expand -group DCIF /dcache_tb/PROG/dcif/imemREN
add wave -noupdate -expand -group DCIF /dcache_tb/PROG/dcif/imemload
add wave -noupdate -expand -group DCIF /dcache_tb/PROG/dcif/imemaddr
add wave -noupdate -expand -group DCIF /dcache_tb/PROG/dcif/dhit
add wave -noupdate -expand -group DCIF /dcache_tb/PROG/dcif/datomic
add wave -noupdate -expand -group DCIF /dcache_tb/PROG/dcif/dmemREN
add wave -noupdate -expand -group DCIF /dcache_tb/PROG/dcif/dmemWEN
add wave -noupdate -expand -group DCIF /dcache_tb/PROG/dcif/flushed
add wave -noupdate -expand -group DCIF -radix unsigned /dcache_tb/PROG/dcif/dmemload
add wave -noupdate -expand -group DCIF -radix unsigned /dcache_tb/PROG/dcif/dmemstore
add wave -noupdate -expand -group DCIF -radix unsigned /dcache_tb/PROG/dcif/dmemaddr
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {617 ns} 0}
